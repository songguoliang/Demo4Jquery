...
define("dialog-config", {
    ...
    // 消息内容
    content: '<span class="ui-alert-loading">Loading..</span>',
    ...
    innerHTML:
        '<div i="dialog" class="ui-alert">'
        +       '<div class="ui-alert-arrow-a"></div>'
        +       '<div class="ui-alert-arrow-b"></div>'
        +       '<table class="ui-alert-grid">'
        +           '<tr>'
        +               '<td i="header" colspan="2" class="ui-alert-header">'
        +                   '<a i="close" class="ui-alert-close" title="关闭" href="javascript:void(0);">×</a>'
        +                   '<div i="title" class="ui-alert-title"></div>'
        +               '</td>'
        +           '</tr>'
        +           '<tr>'
        +				'<td i="icon" style="vertical-align:top"></td>'
        +               '<td i="body" class="ui-alert-body">'
       /* +					'<div i="icon" class="ui-alert-icon"></div>'*/
        +                   '<div i="content" class="ui-alert-content"></div>'
        +               '</td>'
        +           '</tr>'
        +           '<tr>'
        +               '<td i="footer" colspan="2" class="ui-alert-footer">'
        +                   '<div i="statusbar" class="ui-alert-statusbar"></div>'
        +                   '<div i="button" class="ui-alert-button"></div>'
        +               '</td>'
        +           '</tr>'
        +       '</table>'
        +'</div>'
...
$.extend(prototype, {
     ...
     */
    icon: function (html) {
    	html='<div class="ui-alert-icon ui-alert-icon-'+html+'"></div>';
        this._$('icon').empty('')
        [typeof html === 'object' ? 'append' : 'html'](html);
    ...
    button: function (args) {
        ...
        if (typeof args === 'string') {
            ...
            $.each(args, function (i, val) {
                ...
                + (val.autofocus ? ' autofocus class="ui-alert-autofocus"' : '')
                + '>'
                +   val.value
                + '</button>';
